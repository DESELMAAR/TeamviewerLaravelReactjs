...
export default function NavAdmin(){
 ...
 <div class="flex items-center justify-between mx-4 ">
            <Link class="menu-hover  dark:text-white font-medium transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition-none dark:text-white dark:hover:text-white/80 dark:focus:text-white/80 dark:active:text-white/80  " onClick="">
            Manager
            </Link>
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="h-6 w-6 ml-2 dark:text-white/60">
        ...
        <div
            class="invisible absolute soutbar mt-4  flex w-full flex-col NavColor  py-1 mx-4 p-2 text-gray-800 shadow-xl group-hover:visible">

           
            <Link to="/teams" className={SoutNav.style}>
                Teams
            </Link>
            <Link to="/members" className={SoutNav.style}>
                Members
            </Link>

            <Link to="/services" className={SoutNav.style}>
                Services
            </Link>
            

            <Link to="/results" className={SoutNav.style}>
                Results
            </Link>

            {/* <Link to="/addorders"  className={SoutNav.style}>
                Add Order
            </Link> */}
        </div>
    </div>
